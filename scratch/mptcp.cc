...
main(int argc, char *argv[])
{
  ...
  Config::SetDefault("ns3::MpTcpSocketBase::CongestionControl", StringValue("CS218_ALGO"));
  ...
  pointToPoint.EnableAsciiAll(asciiTrace.CreateFileStream("my_first.tr"));
  pointToPoint.EnablePcapAll("firstmptcp");
